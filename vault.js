...
const inventory = [
    ...
    { id: 9, name: "LV Symphony", gender: "Women", file: "Products by Louis Vuitton_ Symphony.png", price: 1100, old: 1600, notes: ["Ginger", "Grapefruit", "Fresh", "Executive"], stock: 1 },
    ...
    { id: 13, name: "Heritage Fenwick", gender: "Men", file: "Fenwick _ UK Department Store _ Fashion, Beauty, & More.png", price: 1250, old: 1800, notes: ["Legacy", "Woody"], stock: 2 },
    { id: 14, name: "Gift Selection No.12", gender: "Unisex", file: "Fragrance Gift Guide_ 12 Perfumes to Give Each___.png", price: 1400, old: 2000, notes: ["Floral", "Citrus"], stock: 4 },
    { id: 15, name: "Seasonal Palette", gender: "Women", file: "How to Choose Fragrances Based on Your Seasonal Color Palette.png", price: 950, old: 1300, notes: ["Spring", "Fresh"], stock: 6 },
    { id: 16, name: "Sun-Warmed Complex", gender: "Women", file: "Quietly complex and sun-warmed_ Spring fragrance has outgrown stale florals.png", price: 1150, old: 1600, notes: ["Warm", "Solar"], stock: 3 },
    { id: 17, name: "Zodia Săgetător", gender: "Men", file: "Top 10 Parfumuri Pentru Bărbați din Zodia Săgetător - Replique Parfumerie.png", price: 890, old: 1200, notes: ["Amber", "Spicy"], stock: 5 },
    { id: 18, name: "Elite Acquisition I", gender: "Men", file: "download (10).png", price: 1300, old: 1900, notes: ["Executive", "Dark"], stock: 1 },
    { id: 19, name: "Elite Acquisition II", gender: "Men", file: "download (11).png", price: 1350, old: 1950, notes: ["Executive", "Fresh"], stock: 2 },
    { id: 20, name: "Elite Acquisition III", gender: "Women", file: "download (12).png", price: 1400, old: 2000, notes: ["Executive", "Woody"], stock: 3 },
    { id: 21, name: "Elite Acquisition IV", gender: "Women", file: "download (13).png", price: 1450, old: 2100, notes: ["Executive", "Floral"], stock: 4 },
    { id: 22, name: "Elite Acquisition V", gender: "Unisex", file: "download (14).png", price: 1500, old: 2200, notes: ["Executive", "Citrus"], stock: 5 },
    { id: 23, name: "Heritage Collection A", gender: "Men", file: "download (5).png", price: 900, old: 1300, notes: ["Legacy", "Fresh"], stock: 7 },
    { id: 24, name: "Heritage Collection B", gender: "Men", file: "download (6).png", price: 920, old: 1350, notes: ["Legacy", "Woody"], stock: 8 },
    { id: 25, name: "Heritage Collection C", gender: "Women", file: "download (7).png", price: 950, old: 1400, notes: ["Legacy", "Floral"], stock: 9 },
    { id: 26, name: "Heritage Collection D", gender: "Women", file: "download (8).png", price: 980, old: 1450, notes: ["Legacy", "Amber"], stock: 10 },
    { id: 27, name: "The Signature", gender: "Unisex", file: "download.png", price: 1600, old: 2300, notes: ["Signature", "Luxury"], stock: 2 },
    { id: 28, name: "YSL MYSLF", gender: "Men", file: "MYSLF Le Parfum - Men's Spicy Vanilla Fragrance - YSL Beauty.jpg", price: 1000, old: 1400, variants: [{size: "60ml", price: 1000, old: 1400}, {size: "100ml", price: 1400, old: 1900}], notes: ["Vanilla", "Spicy", "Dark"], stock: 5 },
    { id: 29, name: "YSL Y EDP", gender: "Men", file: "Ysl.JPG", price: 1200, old: 1650, variants: [{size: "100ml", price: 1200, old: 1650}, {size: "200ml", price: 2100, old: 2800}], notes: ["Fresh", "Executive"], stock: 5 },
    { id: 30, name: "LV Imagination", gender: "Men", file: "LouisVuittonimagination.JPG", price: 4800, old: 5600, notes: ["Fresh", "Citrus"], stock: 3 },
    { id: 31, name: "LV Pacific Chill", gender: "Men", file: "LouisVuittonPacificchill.JPG", price: 4800, old: 5600, notes: ["Fresh", "Fruity"], stock: 3 },
    { id: 32, name: "Dark Verse", gender: "Women", file: "Luna Caine ✩ Dark Verse.webp", price: 1350, old: 1800, notes: ["Dark", "Woody"], stock: 4 },
    { id: 33, name: "PDM Delina Exclusif", gender: "Women", file: "pdm dalida.webp", price: 5800, old: 7200, notes: ["Rose", "Sweet", "Floral"], stock: 2 },
    { id: 34, name: "YSL Libre Intense", gender: "Women", file: "Libre Eau de Parfum Intense Women's Perfume _ YSL Beauty.webp", price: 2400, old: 3100, notes: ["Lavender", "Vanilla", "Sweet"], stock: 4 },
    { id: 35, name: "Valentino Born Roma", gender: "Women", file: "valnteino born in rome intense wommen.jpg", price: 2100, old: 2750, notes: ["Sweet", "Fruity"], stock: 5 },
